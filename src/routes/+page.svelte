...
<!--Hint Area-->
<div>
    <div class="w-[85%] md:w-[50%] lg:w-[45%] px-4 py-1 -translate-y-1/4 mx-auto h-auto rounded-3xl bg-[#850825] border-[1.5px] border-black flex items-center">
        <p class="mx-auto text-lg md:text-2xl lg:text-3xl" style="text-shadow: black 0px 0px 5px;">Guess today's weapon!</p>
    </div>
    <div class="w-[95%] md:w-[80%] lg:w-[40%] h-fit -my-8 bg-red-900 mx-auto mb-3 rounded-2xl border-[1.5px] px-2 py-3 border-black flex flex-col">
...
<div class="w-full">
    <div class="mx-0 sm:mx-auto px-2 w-full xl:w-fit overflow-x-scroll xl:overflow-auto">
